...
export const baseUserRequest =
  "Summarize what this cache experiment is checking, and mention cached_tokens.";
...
export function stableSystemScenario(): CacheScenario {
  return {
    name: "stable-system",
    description:
      "The system prompt is byte-for-byte stable; only the iteration number in the user request changes.",
...
export function randomSystemPrefixScenario(): CacheScenario {
  return {
    ...
    description:
      "A random nonce is inserted at the very beginning of the system prompt on every request.",
    buildMessages: (iteration) => ({
...
export function randomSystemSuffixScenario(): CacheScenario {
  return {
    ...
    description:
      "The stable system prompt stays first, and a random nonce is appended at the end on every request.",
    buildMessages: (iteration) => ({
...
export function randomUserPrefixScenario(): CacheScenario {
  return {
    ...
    description:
      "The system prompt is stable, and a random nonce is inserted at the beginning of the user message.",
    buildMessages: (iteration) => ({
      system: baseSystemPrompt,
