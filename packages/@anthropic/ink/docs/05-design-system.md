...
<Dialog title="Confirm Action" subtitle="This cannot be undone" onCancel={() => setShowDialog(false)} color="warning">
...
<ProgressBar ratio={0.65} width={40} fillColor="rate_limit_fill" emptyColor="rate_limit_empty" />;
```
...
<LoadingState message="Installing dependencies" subtitle="This may take a moment" bold={true} />;
```
...
<SearchBox query={searchQuery} placeholder="Search..." isFocused={true} isTerminalFocused={true} width="100%" />;
```
