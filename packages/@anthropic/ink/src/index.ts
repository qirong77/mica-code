...
export { getKeyName, matchesKeystroke, matchesBinding } from './keybindings/match.js';
export { KeybindingSetup, type KeybindingSetupProps } from './keybindings/KeybindingSetup.js';
export type {
  ParsedBinding,
  ParsedKeystroke,
