...
- 当前内置命令包括：`clear`、`resume`、`provider`、`model`、`effort`、`status`、`context`、`doctor`、`compact`、`new`、`fork`、`agents`、`rewind`、`mcp`、`skills`、`log`、`copy`、`rename`、`git-diff-context`、`review`、`commit`、`exit`。
